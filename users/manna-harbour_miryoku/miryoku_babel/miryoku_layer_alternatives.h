...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              DM_RSTP,           DM_REC1,           DM_REC2,           U_CUT,             U_UND,             \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              U_NU,              DM_PLY1,           DM_PLY2,           KC_MS_U,           KC_MS_R,           \
